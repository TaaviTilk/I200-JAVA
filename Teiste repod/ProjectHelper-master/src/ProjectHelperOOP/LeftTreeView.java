...
public class LeftTreeView {
    ...
    public void setupScene() {
        ...
        //TreeItem<String> rootItem = new TreeItem<>("Minu projektid");
        ...
        projektinimed = a.getProjectNames();
        for (String x : projektinimed){
            ProjectRootItem pri = new ProjectRootItem(x);
            rootItem.getChildren().addAll(pri.treeitem);
        }
        a.sulgeYhendus();
    }
    ...
    public static void handleMouseClicked2(){                                                                           //Nupuvajutusele reageerimine l66dud kaheks, sest nii on lihtsam mujalt callida nupuvajutuse meetodit. N2iteks TopPane.setupDelete(); alt.
        n = (String) ((TreeItem)treeview.getSelectionModel().getSelectedItem()).getValue();
        ...
        if (n == "Minu projektid"){
            ...
            projektidetailid = a.getProjectText(n);
            ...
            if ((projektidetailid.get("projecttext")== null)) {
                RightSplitPane.editor.setHtmlText("");
            }else{
                RightSplitPane.editor.setHtmlText(projektidetailid.get("projecttext"));
            }
            a.sulgeYhendus();
        }
    }
